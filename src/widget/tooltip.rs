...
impl Tooltip {
    pub fn new(systems: &mut DrawSetting) -> Self {
        ...
        window_rect.set_position(Vec3::new(0.0, 0.0, ORDER_TOOLTIP))
            .set_size(Vec2::new(24.0, 24.0))
            .set_color(Color::rgba(130, 130, 130, 255))
            .set_border_width(1.0)
            .set_border_color(Color::rgba(40, 40, 40, 255));
        let window = systems.gfx.add_rect(window_rect, 4);
        systems.gfx.set_visible(window, visible);

        let mut text_label = create_label(systems, 
            Vec3::new(2.0, 2.0, ORDER_TOOLTIP_TEXT),
            Vec2::new(20.0, 20.0),
            Bounds::new(2.0, 2.0, 22.0, 22.0),
            Color::rgba(255, 255, 255, 255));
        text_label.set_buffer_size(&mut systems.renderer, 300, systems.size.height as i32);
        let text = systems.gfx.add_text(text_label, 5);
    ...
    pub fn init_tooltip(&mut self, systems: &mut DrawSetting, screen_pos: Vec2, msg: String) {
        self.start_tmr = true;
        ...
        systems.gfx.set_bound(self.text, 
            Bounds::new(w_pos.x + 8.0, w_pos.y + 8.0, 
                w_pos.x + text_size.x + 8.0, w_pos.y + text_size.y + 8.0));
        systems.gfx.set_pos(self.text, Vec3::new(w_pos.x + 8.0, w_pos.y + 8.0, ORDER_TOOLTIP_TEXT));
        systems.gfx.set_pos(self.window, Vec3::new(w_pos.x, w_pos.y, ORDER_TOOLTIP));
    ...
    pub fn check_tooltip(&mut self, systems: &mut DrawSetting, screen_pos: Vec2) {
    ...
    pub fn handle_tooltip_logic(&mut self, systems: &mut DrawSetting, seconds: f32) {
